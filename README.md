...
Currently into **Agentic Workflows**, specifically solving orchestration challenges in long-context environments.

### 🛠️ Technical Focus
*   **AI & LLMs:** Multimodal transformers, RAG Systems, Human-in-the-Loop AI systems, Model Quantization, TensorFlow/PyTorch
*   **Engineering:** C++ Ops for Inference (TF Serving) & others
